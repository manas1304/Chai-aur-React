...
// Link is used in place of anchor (a) tag because of page refresh
// Link gives access to the isActive method - which tells that are you currently on that page ( matches with the url)
